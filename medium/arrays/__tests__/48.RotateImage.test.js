...
const threeByRotatedThreeMatrix = [
  [7, 4, 1],
  [8, 5, 2],
  [9, 6, 3],
];
...
test("returns rotated matrix", () => {
  ...
  expect(rotateMatrix(threeByThreeMatrix)).toEqual(threeByRotatedThreeMatrix);
  expect(rotateMatrix(fourByfourMatrix)).toEqual(fourByfourRotatedMatrix);
});
